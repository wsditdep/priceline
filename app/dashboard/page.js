                ...
                <div className="dashboard-wrapper">
                    ...
                    <div className="commercial-data-wrapper">
                        <div className="commercial-data-heading">
                            ...
                            <p>Whether you’re buying, selling, or leasing a property, <br />
                                ...
                                or managing diverse portfolios, Priceline has got you covered.</p>
                        </div>
                    ...
                    <div className="membership-type-wrapper">
                        <div className="membership-type-heading">
                            <h2>What sets Priceline apart?</h2>
                            <p>The Priceline membership program offers users a way to earn exclusive commissions by completing bookings.
                                <br /> <br />
